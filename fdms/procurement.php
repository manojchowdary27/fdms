<?php include "header.php"; ?>
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Monthly Report-Procurement & Purchase Section</a></li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>Monthly Report-Procurement</h2><h2 style="color:blue;margin-left:25%;text-align:center;">Total Amount:
