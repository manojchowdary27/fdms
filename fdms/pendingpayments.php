<?php include "header.php"; ?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Pending Payments
                    
                     <?PHP 
                           if($sql2['cou']>=1) echo "<span class='badge' style='background-color:orange;'>".$sql2['cou']."</span>"; ?>
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable" >
                                        ...
                                        <tbody ng-app="payments" ng-controller="paymentsCtrl">
                                            <?Php
                                             $sql = mysql_query('select * from payment_history where approvalStatus=1 order By date desc');
                                            ...
                                            <tr>
												...
												<td id="<?php echo "man".$res['sno'] ?>" ><button ng-click="makeitapp(<?php echo $res['sno'];?>)" class="btn btn-info btn-lg "><span class="fa fa-check"></span></button></td>
                                            </tr>
										<?php }?>
                                        </tbody>
                                    </table>                                    
