<?php include "header.php"; ?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>Login Requests </h2>
                </div>
                <!-- END PAGE TITLE -->                
                                ...
                                <div class="panel-body">
                                    <table id="customers2" class="table datatable" >
                                        ...
                                        <tbody ng-app="payments" ng-controller="paymentsCtrl">
                                            <?Php
                                             $sql = mysql_query('select * from loginrequests order By intime asc') or die("Error occured while fetching the data");
											while($res = mysql_fetch_array($sql)){?>
                                            <tr>
												<td  style="max-width:15px;padding:0px;text-align:left;" ><?php echo $res['sno'];?></td>
                                                <td style="max-width:70px;padding:0px;text-align:left;"  ><?php echo $res['username'];?></td>
                                                <td><?php echo $res['status'];?></td>
                                                <td><?php echo $res['intime'];?></td>
                                                <td><?php echo $res['outime'];?></td>
